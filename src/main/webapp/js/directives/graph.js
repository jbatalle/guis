...
//                        graph.setNodes(localStorageService.get("graphNodes"));
                        ...
                        var networkElements = [
                            {x:350, y:200, "_id": "openflowswitch:OFSwitch-4", "_xmlns:xsi": "http://www.w3.org/2001/XMLSchema-instance","_xsi:type": "switch", ports: {port: [{"_id":"OF11"}, {"_id":"OF12"}, {"_id":"OF13"}]}},
                            {x:250, y:100, "_id": "openflowswitch:OFSwitch-5", "_xmlns:xsi": "http://www.w3.org/2001/XMLSchema-instance","_xsi:type": "switch", ports: {port:[{"_id":"OF21"}, {"_id":"OF22"}]}},
                            {x:250, y:300, "_id": "openflowswitch:OFSwitch-6", "_xmlns:xsi": "http://www.w3.org/2001/XMLSchema-instance","_xsi:type": "switch", ports: {port:[{"_id":"OF31"}, {"_id":"OF32"}]}},
                            {x:550, y:200, "_id": "tson:Tson-9", "_xmlns:xsi": "http://www.w3.org/2001/XMLSchema-instance","_xsi:type": "tson", ports: {port:[{"_id":"T11"}, {"_id":"T12"}, {"_id":"T13"}]}},
                            {x:650, y:100, "_id": "tson:Tson-10", "_xmlns:xsi": "http://www.w3.org/2001/XMLSchema-instance","_xsi:type": "tson", ports: {port:[{"_id":"T21"}, {"_id":"T22"}]}},
                            {x:650, y:300, "_id": "tson:Tson-11", "_xmlns:xsi": "http://www.w3.org/2001/XMLSchema-instance","_xsi:type": "tson", ports: {port:[{"_id":"T31"}, {"_id":"T32"}]}},
                            {x:100, y:100, "_id": "tson:Wifi-4", "_xmlns:xsi": "http://www.w3.org/2001/XMLSchema-instance","_xsi:type": "wifi", ports: {port:[{"_id":"CHANNEL-1"}, {"_id":"CHANNEL-1"},{"_id":"CHANNEL-2"}, {"_id":"CHANNEL-3"},{"_id":"CHANNEL-4"}, {"_id":"CHANNEL-5"},{"_id":"CHANNEL-6"}, {"_id":"CHANNEL-7"}]}},
                            {x:100, y:150, "_id": "tson:Wifi-5", "_xmlns:xsi": "http://www.w3.org/2001/XMLSchema-instance","_xsi:type": "wifi", ports: {port:[{"_id":"T31"}, {"_id":"T32"}]}},
                        ];
...
//                        graph.setNodes(localStorageService.get("graphNodes"));
                        ...
                        var networkElements = [
                            ...
                            {x:650, y:100, "_id": "tson:Tson-10", "_xmlns:xsi": "http://www.w3.org/2001/XMLSchema-instance","_xsi:type": "tson", ports: {port:[{"_id":"T21"}, {"_id":"T22"}]}},
                            {x:650, y:300, "_id": "tson:Tson-11", "_xmlns:xsi": "http://www.w3.org/2001/XMLSchema-instance","_xsi:type": "tson", ports: {port:[{"_id":"T31"}, {"_id":"T32"}]}},
                            {x:100, y:100, "_id": "tson:Wifi-4", "_xmlns:xsi": "http://www.w3.org/2001/XMLSchema-instance","_xsi:type": "wifi", ports: {port:[]}},
                            {x:100, y:150, "_id": "tson:Wifi-5", "_xmlns:xsi": "http://www.w3.org/2001/XMLSchema-instance","_xsi:type": "wifi", ports: {port:[]}},
                        ];
                        var links = [{srcPort:"T11", dstPort:"OF11"},
                            {srcPort:"OF12", dstPort:"OF21"},{srcPort:"OF22", dstPort:"OF31"},{srcPort:"OF32", dstPort:"OF13"},
                            {srcPort:"T12", dstPort:"T21"},{srcPort:"T22", dstPort:"T31"},{srcPort:"T32", dstPort:"T13"}
