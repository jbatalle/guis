...
angular.module('mqnaasApp')
    .controller('SodalesMonitoringController', function ($scope, $filter, localStorageService, $modal, arnService, cpeService, $interval) {
        var promise;
        ...
        $scope.dropdown2 = [{
            ...
            "click": "selectedResource('', 'ARN/OAM')"
        }];
        $scope.dropdown = [{
            "text": "CFM/OAM",
            "click": "selectedResource('', 'CFM/OAM')"
        }];
    ...
    .controller('statisticsDialogCtrl', function ($scope, $filter, localStorageService, arnService, $interval) {
        var promise;
